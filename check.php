<?php
    ...
    $repass = $_POST['repass']; // Записываем в переменную $repass значение из окна ввода подтверждения пароля

    if ($pass != $repass) { //Сравниваем значения $pass и $repass, если они разные то выводим ошибку
        echo "Пароли не совпадают";
        exit();
    } else if(mb_strlen($login) < 5 || mb_strlen($login) > 90) { //Получаем длину строки $login и если она меньше 5 или больше 90 то выводим ошибку
    ...
    header('Location: /lab_2_egor/login.php'); // Переадресация на ту же страницу
    ?>
